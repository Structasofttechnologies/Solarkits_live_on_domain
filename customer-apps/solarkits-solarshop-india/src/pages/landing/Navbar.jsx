        ...
        <div style={{
          ...
          >
            <div style={{
              ...
              <img src={logo} alt="SolarKits" style={{ height: "32px", objectFit: "contain", maxWidth: "130px" }} />
            </div>
          </motion.div>

          {/* Desktop Nav Links */}
          <div style={{ display: "flex", gap: "32px", alignItems: "center" }} className="landing-hide-mobile">
            {NAV_LINKS.map((link) => (
              <button
                key={link.label}
          ...
          <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
            ...
            <div className="landing-hide-mobile" style={{ display: "flex", gap: "12px", alignItems: "center" }}>
              <motion.button
            ...
            <motion.button
              ...
              style={{
                ...
                color: "#0f172a", borderRadius: "10px",
                width: "42px", height: "42px", cursor: "pointer",
                alignItems: "center", justifyContent: "center",
                boxShadow: "0 2px 8px rgba(0,0,0,0.04)"
              }}
            >
              {menuOpen ? <FiX style={{ fontSize: "1.4rem", color: "#1e40af" }} /> : <FiMenu style={{ fontSize: "1.4rem", color: "#0f172a" }} />}
            </motion.button>
          </div>
        </div>
      </motion.nav>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                {NAV_LINKS.map((link, i) => (
                  ...
                  >
                    ...
                    <FiChevronRight style={{ color: "#94a3b8", fontSize: "1.1rem" }} />
                  </motion.button>
                ))}
              </div>

              <div style={{ height: "1px", background: "#e2e8f0", margin: "20px 0 16px" }} />
