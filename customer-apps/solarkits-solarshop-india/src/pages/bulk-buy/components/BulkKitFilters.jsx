          ...
          <div key={section.title} className="border-b border-border last:border-b-0">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                {activeCount > 0 && (
                  <span className="bg-linear-120 from-primary to-primary-end text-white rounded-full w-5 h-5 text-xs flex items-center justify-center font-medium">
                    {activeCount}
                  </span>
                )}
              </div>
                ...
                {filtersToRender.map(({ label, key, options }) => {
                  ...
                  return (
                    <div key={key} className="relative">
                      ...
                      />
                      {isActive && (
                        <div className="absolute -right-1 -top-1 w-2 h-2 bg-linear-120 from-primary to-primary-end rounded-full ring-2 ring-white"></div>
                      )}
                    </div>
                  );
                })}
      ...
      {clearFilters && (
        <div className="p-4 border-t border-border mt-2">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="bg-linear-120 from-primary to-primary-end text-white rounded-full w-6 h-6 text-xs flex items-center justify-center font-bold">
