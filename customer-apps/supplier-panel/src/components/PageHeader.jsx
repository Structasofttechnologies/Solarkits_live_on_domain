...
const PageHeader = ({ 
  ...
  return (
    <div className={`relative w-full overflow-hidden rounded-2xl gradient-primary shadow-xl mb-8 ${className}`}>
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <nav className="flex items-center gap-2 text-white/70 text-xs font-medium mb-3 uppercase tracking-wider">
                <Link to="/dashboard/home" className="hover:text-white transition-colors flex items-center gap-1">
                  <FiHome size={12} />
                  Home
                </Link>
