...
const SLIDES = [
  {
    id: 1,
    tag: "🌞 India's #1 Solar Marketplace",
    title: "Power Your Home\nWith Clean Solar",
    subtitle: "Get the best solar panels, inverters & kits — delivered to your door. Save up to ₹78,000 with PM Surya Ghar Subsidy.",
    cta1: { label: "Shop Solar Panels", href: "#products" },
  ...
  },
  {
    ...
    subtitle: "Under PM Surya Ghar Muft Bijli Yojana, eligible households get 300 units free electricity + cashback subsidy. Apply now through SolarKits!",
    cta1: { label: "Check Eligibility", href: "#subsidy" },
  ...
  {
    id: 3,
    tag: "⚡ Complete Solar Kits",
    title: "Everything You Need\nin One Box",
    subtitle: "From 1kW to 100kW — our complete solar kits include panels, inverter, batteries & mounting. Plug & produce in 48 hours!",
    cta1: { label: "View Solar Kits", href: "#kits" },
