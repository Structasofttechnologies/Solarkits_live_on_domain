const Button = ({
  ...
  const variantClasses = {
    ...
    outline: 'bg-transparent text-primary dark:text-info border-1 border-primary dark:border-info hover:bg-linear-120 from-primary to-primary-end hover:text-text-inverse',
    danger: 'btn-danger',
    success: 'btn-success',
    warning: 'btn-warning',
