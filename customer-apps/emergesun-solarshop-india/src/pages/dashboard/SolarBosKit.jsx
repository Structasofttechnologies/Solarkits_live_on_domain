                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          <div className="w-12 h-12 rounded-xl overflow-hidden border border-border shrink-0 bg-surface-hover shadow-xs">
                            <BosImage
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          ...
                          <div className="flex items-center border border-border rounded-lg bg-surface overflow-hidden">
                            <button
                              ...
                              className="p-1.5 text-text-secondary hover:text-text-primary hover:bg-surface-hover transition"
                              title="Decrease"
                            >
                              <FiMinus size={14} />
                            </button>
                            <span className="px-3 py-1 text-xs font-extrabold min-w-[28px] text-center">
                              {qty}
                            </span>
                            <button
                              type="button"
