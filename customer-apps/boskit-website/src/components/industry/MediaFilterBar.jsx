 ...
 * MediaFilterBar.jsx
 *
 * Compact Media-Type Filter Pills & Sort Selector for Distributor Portal.
 */
...
const FILTER_CONFIG = [
  ...
  { key: 'VIDEO', label: 'Demo Videos', icon: FiVideo },
  { key: 'PHOTO', label: 'Equipment Photos', icon: FiImage },
  { key: 'POSTER', label: 'Tech Posters', icon: FiFileText },
];
    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 py-1">
      ...
      <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
        ...
        <select
          ...
          className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-1.5 text-xs font-bold text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0575B8]/20 cursor-pointer"
        >
