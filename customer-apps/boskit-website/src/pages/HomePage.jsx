...
function HeroSection() {
  ...
  return (
    <section className="relative pt-16 pb-20 overflow-hidden bg-gradient-to-b from-[#EFF8FF]/80 via-[#F8FAFC] to-[#FFFFFF] border-b border-[#E2E8F0]">
      {/* Decorative background glow */}
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-[#0575B8]/10 blur-[100px] pointer-events-none rounded-full" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center max-w-3xl mx-auto space-y-6">

          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#EFF8FF] border border-[#BAE6FD] text-[#0575B8] text-xs font-bold shadow-xs">
            <span className="w-2 h-2 rounded-full bg-[#0575B8] animate-pulse" />
            B2B Solar Equipment Distribution Network
          </div>

          {/* Headline */}
          <h1 className="font-heading font-black text-4xl sm:text-5xl lg:text-6xl tracking-tight text-[#0F172A] leading-[1.1]">
            Become an Authorized{' '}
            <span className="text-[#0575B8]">District Solar Distributor</span>
          </h1>
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
            {role === 'distributor' ? (
              <Link
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-2xl text-base font-bold bg-[#0575B8] text-white hover:bg-[#045D93] shadow-md hover:shadow-lg hover:scale-[1.01] active:scale-98 transition-all flex items-center justify-center gap-3"
              >
                <FiZap className="w-5 h-5 text-[#F49222]" />
              ...
              <Link
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-2xl text-base font-bold bg-[#0575B8] text-white hover:bg-[#045D93] shadow-md hover:shadow-lg hover:scale-[1.01] active:scale-98 transition-all flex items-center justify-center gap-3"
              >
                <FiAward className="w-5 h-5 text-[#F49222]" />
            ...
            <Link
              to="/products"
              className="w-full sm:w-auto px-7 py-4 rounded-2xl text-base font-bold bg-[#FFFFFF] hover:bg-[#EFF8FF] text-[#0575B8] border border-[#0575B8]/30 shadow-xs flex items-center justify-center gap-2 transition-all"
            >
          ...
          {!isAuthenticated && (
            <p className="text-xs text-[#64748B] pt-1">
              ...
              <Link to="/auth/login" className="font-bold text-[#0575B8] hover:underline">
          ...
          {/* Trust signals */}
          <div className="pt-2 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-[#475569]">
            {[
              ...
              <span key={t} className="flex items-center gap-1.5 font-medium">
                <FiCheckCircle className="text-[#0575B8] w-3.5 h-3.5 shrink-0" />
                {t}
              </span>
            ))}
          </div>
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="bg-[#FFFFFF] rounded-2xl p-5 text-center border border-[#E2E8F0] shadow-xs hover:border-[#0575B8]/40 hover:shadow-md transition-all">
              <div className="w-10 h-10 mx-auto mb-3 rounded-xl bg-[#EFF8FF] border border-[#BAE6FD] flex items-center justify-center text-[#0575B8]">
                <stat.icon className="w-5 h-5" />
              </div>
              <div className="font-heading font-extrabold text-2xl text-[#0F172A] tracking-tight">{stat.value}</div>
              <div className="text-xs text-[#64748B] font-medium mt-1">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
...
function DistributorPlansSection({ plans, loading }) {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-[#F8FAFC] rounded-3xl p-8 sm:p-12 border border-[#E2E8F0]">
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-2">
          <span className="text-xs font-bold text-[#0575B8] uppercase tracking-widest bg-[#EFF8FF] px-3 py-1 rounded-full border border-[#BAE6FD]">
            DISTRIBUTOR TIERS
          </span>
          <h2 className="font-heading font-bold text-3xl sm:text-4xl text-[#0F172A] tracking-tight mt-1">
          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`rounded-2xl p-7 flex flex-col justify-between transition-all duration-300 relative ${
                plan.is_popular
                  ? 'bg-[#FFFFFF] border-2 border-[#0575B8] shadow-xl scale-105'
                  : 'bg-[#FFFFFF] border border-[#E2E8F0] shadow-xs hover:shadow-md hover:border-[#0575B8]/40'
              }`}
            >
              {plan.is_popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3.5 py-1 rounded-full text-[11px] font-extrabold uppercase tracking-wider bg-[#F49222] text-white shadow-xs">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-heading font-bold text-xl text-[#0F172A]">{plan.name}</h3>
                  <p className="text-xs text-[#475569] mt-1 leading-relaxed">{plan.short_description || plan.description}</p>
                </div>

                <div className="pt-2 pb-4 border-y border-[#E2E8F0]">
                  <div className="flex items-baseline gap-1">
                    <span className="text-xs text-[#475569] font-medium">Joining Fee:</span>
                    <span className="font-heading font-extrabold text-2xl text-[#0575B8]">
                      ₹{(plan.joining_fee_inr || 25000).toLocaleString('en-IN')}
                    </span>
                  </div>
                  <div className="text-[11px] text-[#475569] mt-1">
                    Validity: <strong className="text-[#0F172A]">{plan.validity_display || `${plan.validity_value || 12} Months`}</strong> | Territory: <strong className="text-[#0F172A]">{plan.allowed_territories_count || 1} {plan.territory_type || plan.territory_level || 'District'} ({plan.is_territory_exclusive ? 'Exclusive' : 'Shared'})</strong>
                  </div>
                </div>
...
function OnboardingStepsSection() {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-[#FFFFFF] rounded-3xl p-8 sm:p-12 border border-[#E2E8F0] shadow-xs">
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-2">
          <span className="text-xs font-bold text-[#0575B8] uppercase tracking-widest bg-[#EFF8FF] px-3 py-1 rounded-full border border-[#BAE6FD]">
            Rapid Onboarding
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="relative p-5 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] space-y-2 hover:border-[#0575B8]/40 transition-colors">
              <span className="font-heading font-black text-3xl text-[#E2E8F0]">{s.step}</span>
              <h4 className="font-heading font-bold text-base text-[#0F172A]">{s.title}</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {props.map((prop, idx) => {
          ...
          return (
            <div
              key={idx}
              className="bg-[#FFFFFF] rounded-2xl p-6 border border-[#E2E8F0] shadow-xs flex flex-col gap-4 hover:shadow-md hover:border-[#0575B8]/40 transition-all"
            >
              <div className="w-11 h-11 rounded-xl bg-[#EFF8FF] border border-[#BAE6FD] flex items-center justify-center text-[#0575B8] shadow-xs">
                <Icon className="w-5 h-5" />
              </div>
              <span className="inline-block text-[11px] font-bold text-[#0575B8] bg-[#EFF8FF] px-2 py-0.5 rounded border border-[#BAE6FD] self-start">
                {prop.badge}
              </span>
              <div>
                <h3 className="font-heading font-bold text-base text-[#0F172A] leading-snug">{prop.title}</h3>
                <p className="text-sm text-[#475569] leading-relaxed mt-1">{prop.desc}</p>
              </div>
            </div>
          );
        })}
...
function BottomCTASection() {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="rounded-3xl p-8 sm:p-12 bg-gradient-to-r from-[#EFF8FF] via-[#F8FAFC] to-[#EFF8FF] border border-[#BAE6FD] shadow-xs relative overflow-hidden">
        <div className="max-w-2xl space-y-4">
          <span className="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-[#F49222] text-white inline-block shadow-xs">
            Territories Open For FY 2026
          </span>
          <h2 className="font-heading font-black text-2xl sm:text-4xl tracking-tight text-[#0F172A]">
            Ready to Claim Your District Territory Exclusivity?
          </h2>
          <p className="text-[#475569] font-medium text-sm sm:text-base">
            Join 750+ commercial distributors accelerating their solar wholesale revenue across India.
          </p>
          <div className="pt-2 flex flex-col sm:flex-row gap-3">
            <Link
              to="/auth/register"
              className="px-7 py-3.5 rounded-xl text-sm font-bold bg-[#0575B8] text-white hover:bg-[#045D93] shadow-md flex items-center justify-center gap-2 transition-all"
            >
              Apply as Distributor <FiArrowRight className="w-4 h-4 text-[#F49222]" />
            </Link>
            <Link
              to="/plans"
              className="px-6 py-3.5 rounded-xl text-sm font-bold bg-[#FFFFFF] hover:bg-[#EFF8FF] text-[#0F172A] border border-[#E2E8F0] shadow-xs flex items-center justify-center transition-all"
            >
