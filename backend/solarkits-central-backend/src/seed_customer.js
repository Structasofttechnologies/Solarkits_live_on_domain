...
async function seedCustomer() {
  try {
    const email = 'customer@solarkits.com';
    ...
    if (existing) {
      ...
      await existing.save();
      console.log('✅ Updated existing customer@solarkits.com user account in MongoDB!');
    } else {
      ...
      console.log('✅ Created new customer@solarkits.com user account in MongoDB!');
    }
    process.exit(0);
  } catch (err) {
