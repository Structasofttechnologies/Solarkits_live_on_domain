...
const dynamic_attribute_upload = (type = "product") => {
  return (req, res, next) => {
    try {
      const folder =
        type === "sku"
          ? "solarkits/solarkits-operation-management-panel-backend/public/uploads/skus"
          : "solarkits/solarkits-operation-management-panel-backend/public/uploads/products";
