...
// subtype_attributes — subtype_id, group_id, unit_group_id SAME DB → ObjectId
const s = new mongoose.Schema({

  name: { type: String, required: true, trim: true },
  subtype_id: { type: mongoose.Schema.Types.ObjectId, ref: 'pc_product_subtypes', required: true },

  group_id: { type: mongoose.Schema.Types.ObjectId, ref: 'pc_attribute_groups', default: null },

  unit_group_id: { type: mongoose.Schema.Types.ObjectId, ref: 'pc_unit_groups', default: null },
