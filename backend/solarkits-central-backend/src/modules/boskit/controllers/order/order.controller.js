    ...
    const [order] = await BoskitOrder.create([
      {
        ...
        items: pricing.items.map((i) => ({
          ...
          price_snapshot: {
            ...
            price_before_gst_paise: i.unit_net_paise,
            gst_pct: i.gst_rate_percent,
            gst_amount_paise: i.total_tax_paise / (i.quantity || 1),
            unit_price_paise: i.unit_net_paise,
            moq: i.moq,
            moq_met: i.moq_met,
            pricing_explanation: `Channel ${buyerType} wholesale discount: -${i.discount_percent}%`,
          },
