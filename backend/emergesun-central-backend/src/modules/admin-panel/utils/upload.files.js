...
function upload_files(upload_dir, max_size_mb, field_name, files_length) {
  ...
  const folder = `emergesun/emergesun-admin-panel-backend/${upload_dir.replace(/\\/g, "/")}`;
...
// upload_dir is used to derive Cloudinary folder:
//   "public/uploads/combo_kits" → "emergesun/emergesun-admin-panel-backend/public/uploads/combo_kits"
// -----------------------------------------------
