...
const dynamic_attribute_upload = (type = "product") => {
  return (req, res, next) => {
    try {
      const folder =
        type === "sku"
          ? "emergesun/emergesun-operation-management-panel-backend/public/uploads/skus"
          : "emergesun/emergesun-operation-management-panel-backend/public/uploads/products";
