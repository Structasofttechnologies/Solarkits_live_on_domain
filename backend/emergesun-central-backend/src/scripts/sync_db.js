...
const SOURCE_DATABASES = [
  'emergesun_cms_users',
  'emergesun_geolocations',
  'emergesun_company_warehouses',
  'emergesun_core_db',
  'emergesun_india_core_db',
  'emergesun_india_solarshop',
  'emergesun_supplier_db'
];

const DEST_URI = 'mongodb://localhost:27017/emergesun-project';
...
async function syncAll() {
  ...
  const boundaryUri = 'mongodb+srv://testemergesun:EqKtvAp0JGffusIE@cluster0.tidjbfb.mongodb.net/geolocations';
  ...
  console.log('\n🎉 ALL 8 DATABASES SYNCED INTO LOCAL emergesun-project!');
