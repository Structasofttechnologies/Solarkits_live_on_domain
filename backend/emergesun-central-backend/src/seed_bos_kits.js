...
const customCatalogToSeed = [
  {
    ...
    icon: "📦",
    items: [
      { id: "c_dcdb_1in1out", name: "DCDB 1-In 1-Out (1000V DC SPD + 32A MCB)", unitPrice: 1850, unit: "Box", icon: "⚡", imageUrl: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&auto=format&fit=crop&q=80" },
      { id: "c_dcdb_2in2out", name: "DCDB 2-In 2-Out Dual String (1000V SPD + Fuses)", unitPrice: 3400, unit: "Box", icon: "⚡", imageUrl: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&auto=format&fit=crop&q=80" },
      { id: "c_acdb_1phase", name: "ACDB Single Phase (32A MCB + Type-2 275V SPD)", unitPrice: 1950, unit: "Box", icon: "⚡", imageUrl: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&auto=format&fit=crop&q=80" },
      { id: "c_acdb_3phase", name: "ACDB 3-Phase (63A 4P MCCB + 415V Type-2 SPD)", unitPrice: 5800, unit: "Box", icon: "⚡", imageUrl: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=400&auto=format&fit=crop&q=80" },
      { id: "c_ajb_8in", name: "Central Array Junction Box (AJB) 8-In 1-Out", unitPrice: 12500, unit: "Unit", icon: "🏭", imageUrl: "https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=400&auto=format&fit=crop&q=80" }
    ]
  },
  {
    ...
    icon: "🔌",
    items: [
      { id: "c_dc_cable_4sqmm", name: "4 sq mm Solar DC Cable (Polycab UV Protected)", unitPrice: 42, unit: "Meter", icon: "🔌", imageUrl: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80" },
      { id: "c_dc_cable_6sqmm", name: "6 sq mm Solar DC Cable (Heavy Duty Tinned Copper)", unitPrice: 65, unit: "Meter", icon: "🔌", imageUrl: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80" },
      { id: "c_dc_cable_10sqmm", name: "10 sq mm Armored Solar DC Cable", unitPrice: 110, unit: "Meter", icon: "🔌", imageUrl: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80" },
      { id: "c_mc4_pair", name: "IP68 Waterproof MC4 Connector Pair", unitPrice: 65, unit: "Pair", icon: "🔌", imageUrl: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80" },
      { id: "c_mc4_branch", name: "Y-Branch 2-in-1 MC4 Parallel Connectors", unitPrice: 180, unit: "Pair", icon: "🔌", imageUrl: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1544724569-5f546fd6f2b5?w=400&auto=format&fit=crop&q=80" }
    ]
  },
  {
    ...
    icon: "⚡",
    items: [
      { id: "c_earth_rod_1_2m", name: "1.2m Pure Copper Bonded Earthing Rod (100 Micron)", unitPrice: 1450, unit: "Rod", icon: "⚡", imageUrl: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80" },
      { id: "c_earth_rod_2_0m", name: "2.0m Heavy Chemical Earthing Rod (250 Micron)", unitPrice: 2850, unit: "Rod", icon: "⚡", imageUrl: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80" },
      { id: "c_bfc_compound", name: "Backfill Chemical Compound (BFC 15kg Bag)", unitPrice: 450, unit: "Bag", icon: "🧪", imageUrl: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80" },
      { id: "c_ese_arrester", name: "ESE Early Streamer Emission Lightning Arrester (35m Radius)", unitPrice: 4500, unit: "Set", icon: "⚡", imageUrl: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80" },
      { id: "c_earth_strip_copper", name: "Copper Earthing Strip 25x3mm", unitPrice: 280, unit: "Meter", icon: "⚡", imageUrl: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1513828583688-c52646db42da?w=400&auto=format&fit=crop&q=80" }
    ]
  },
  {
    ...
    icon: "🏗️",
    items: [
      { id: "c_mms_rail_2_1m", name: "Anodized Aluminium Mounting Rail (2.1 Meter)", unitPrice: 650, unit: "Length", icon: "🏗️", imageUrl: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80" },
      { id: "c_mid_clamp", name: "Aluminium Solar Panel Mid Clamp with SS304 Bolt", unitPrice: 45, unit: "Piece", icon: "🔧", imageUrl: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80" },
      { id: "c_end_clamp", name: "Aluminium Solar Panel End Clamp with SS304 Bolt", unitPrice: 45, unit: "Piece", icon: "🔧", imageUrl: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80" },
      { id: "c_l_feet", name: "Heavy Duty L-Feet Mount Connector for Concrete Roof", unitPrice: 85, unit: "Piece", icon: "🏗️", imageUrl: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80" },
      { id: "c_walkway_grating", name: "FRP Roof Walkway Grating (Non-Conductive)", unitPrice: 750, unit: "Meter", icon: "🏗️", imageUrl: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80", image: "https://images.unsplash.com/photo-1558441719-234757452558?w=400&auto=format&fit=crop&q=80" }
    ]
  }
];
