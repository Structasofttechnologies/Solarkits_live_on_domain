...
// 9. website routes 
const website_router = require('./modules/emergesun-website/routes/header.route');
const about_router = require('./modules/emergesun-website/routes/about.route');
const about_details_router = require('./modules/emergesun-website/routes/about_details.route');
const contact_router = require('./modules/emergesun-website/routes/contact.route');
const footer_router = require('./modules/emergesun-website/routes/footer.route');
const erp_modules_router = require('./modules/emergesun-website/routes/erp_modules.route');
const hero_section_router = require('./modules/emergesun-website/routes/hero_section.route');
const erp_benefits_router = require('./modules/emergesun-website/routes/erp_benefits.route');
const happy_users_router = require('./modules/emergesun-website/routes/happy_users.route');
const key_features_router = require('./modules/emergesun-website/routes/key_features.route');
const erp_screenshots_router = require('./modules/emergesun-website/routes/erp_screenshots.route');
const services_router = require('./modules/emergesun-website/routes/services.route');
const pricing_plans_router = require('./modules/emergesun-website/pricing-plans/pricingPlan.routes');
const call_to_action_router = require('./modules/emergesun-website/routes/CallToActionRoutes');
const solar_shop_router = require('./modules/emergesun-website/routes/solar_shop.route');
const marketplace_router = require('./modules/emergesun-website/routes/marketplace.route');
const dealer_app_router = require('./modules/emergesun-website/routes/dealer_app.route');
const megawatt_router = require('./modules/emergesun-website/routes/megawatt.route');
const amc_router = require('./modules/emergesun-website/routes/amc.route');
const website_auth_router = require('./modules/emergesun-website/routes/auth.route');
