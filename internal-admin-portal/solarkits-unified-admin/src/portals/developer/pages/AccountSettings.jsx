    ...
    return (
        <div className="w-full animate-in fade-in duration-700">
            <PageHeader
                ...
                subtitle="Manage your professional identity and workspace preferences."
                icon={HiUser}
            />
                            ...
                            <div className="p-6 space-y-8 animate-in slide-in-from-right-4 duration-500">
                                <div className="flex flex-col md:flex-row items-center gap-8 border-b border-border pb-8">
                                    ...
                                    <div className="text-center md:text-left space-y-2">
                                        ...
                                        <p className="text-text-muted text-sm font-medium">Update your photo and personal details.</p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <CustomInput label="Professional Email" value={user?.email} icon={<HiOutlineMail />} disabled />
                                    <CustomInput label="Contact Number" value={user?.phone || '+91 00000 00000'} icon={<HiOutlinePhone />} />
                                    <CustomInput label="Department" value={user?.department || 'Engineering'} icon={<HiShieldCheck />} disabled />
                                </div>
                        ...
                        {activeTab === 'security' && (
                            <div className="p-6 space-y-8 animate-in slide-in-from-right-4 duration-500">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-text-muted text-sm font-medium">Manage your password and account security protocols.</p>
                                </div>
