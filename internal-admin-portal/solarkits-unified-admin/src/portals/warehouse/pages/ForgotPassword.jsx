// ForgotPassword.jsx - Forgot Password (matching CMS pattern)
...
export default function ForgotPassword() {
  ...
  const getVerificationCode = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/auth/request-forgot-password-otp`, {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Enter your email or phone to receive a verification code for password reset"
