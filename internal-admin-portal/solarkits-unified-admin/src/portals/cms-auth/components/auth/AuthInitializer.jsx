                    ...
                    const getRedirectUrl = (url_prefix) => {
                        ...
                        if (isVercel) {
                            if (url_prefix.startsWith("/admin-panel")) {
                                return `https://solarkits-admin-panel-frontend.vercel.app${url_prefix}/`;
                            }
                            if (url_prefix.startsWith("/developer-panel")) {
                                return `https://solarkits-developer-panel-frontend.vercel.app${url_prefix}/`;
                            }
                            if (url_prefix.startsWith("/operation-management-panel")) {
                                return `https://solarkits-operation-management-panel-frontend.vercel.app${url_prefix}/`;
                            }
                            if (url_prefix.startsWith("/warehouse-management-panel")) {
                                return `https://solarkits-warehouse-panel-frontend.vercel.app${url_prefix}/`;
                            }
                        }
                        return `${url_prefix}/`;
                    };
