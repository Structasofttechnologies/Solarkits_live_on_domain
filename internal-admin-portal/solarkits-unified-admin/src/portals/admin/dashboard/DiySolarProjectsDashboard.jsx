...
import Home from "@/pages/diy-solar-projects/Home";
...
const menus = [
  [
    { name: "Dashboard", icon: <FaHome />, path: "/admin-panel/diy-solar-projects/home" },
  ],
  [
    {
      name: "Sales",
      icon: <MdShoppingCart />,
      path: "/admin-panel/diy-solar-projects/sales",
      subMenu: [
        {
          name: "Orders",
          icon: <MdShoppingCart />,
          path: "/admin-panel/diy-solar-projects/sales/orders",
          subMenu: [
            { name: "Pending", icon: <MdShoppingCart />, path: "/admin-panel/diy-solar-projects/sales/orders/pending" },
            { name: "Completed", icon: <MdShoppingCart />, path: "/admin-panel/diy-solar-projects/sales/orders/completed" },
          ],
        },
        { name: "Invoices", icon: <MdShoppingCart />, path: "/admin-panel/diy-solar-projects/sales/invoices" },
      ],
    },
    { name: "Inventory", icon: <MdInventory />, path: "/admin-panel/diy-solar-projects/inventory" },
    { name: "Customers", icon: <MdPeople />, path: "/admin-panel/diy-solar-projects/customers" },
  ],
];

export default function DiySolarProjectsDashboard() {
    ...
    const checkProductMarket = async () => {
      try {
        ...
        if (res.data?.status === "success") {
          ...
          const foundProduct = allProducts.find(p => p.slug === "diy-solar-projects");
          ...
          const slugIndex = parts.indexOf("diy-solar-projects");
          if (slugIndex !== -1) {
            ...
            if (hasCountry) {
              ...
              if (!subPath) {
                navigate(`/admin-panel/diy-solar-projects/${nextSegment.toLowerCase()}/home`, { replace: true });
              }
            } else {
              ...
              navigate(`/admin-panel/diy-solar-projects/${defaultCountry}/${subPath}`, { replace: true });
            }
          }
  ...
  return (
    <div className="flex h-screen bg-bg theme-transition">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <Header isOpen={isOpen} setIsOpen={setIsOpen} isMobile={isMobile} title="DIY Solar Dashboard" />
