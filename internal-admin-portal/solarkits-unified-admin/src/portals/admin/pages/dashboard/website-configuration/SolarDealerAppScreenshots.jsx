...
const DEFAULT_CONFIG = {
  ...
  screenshotsList: [
    { title: "Dashboard", description: "Complete overview of your business with real-time analytics, sales performance, and key metrics at a glance", enabled: true },
    { title: "Project Signup", description: "Complete project lifecycle management - Lead tracking, Site Survey, Quote Generation, and Project Signup workflow", enabled: true },
    { title: "Project Management", description: "End-to-end Service Management - Installation tracking, Timeline management, Task assignment, and Progress monitoring", enabled: true },
    { title: "Combo Kits", description: "Pre-configured solar combo kits management - Order processing, Kit assembly tracking, Inventory management for complete solar packages", enabled: true }
  ],
...
export default function SolarDealerAppScreenshots() {
  ...
  useEffect(() => {
    fetchDealerAppScreenshots();
  }, []);

  const fetchDealerAppScreenshots = async () => {
    setLoading(true);
    try {
  ...
  const handleReset = () => {
    if (window.confirm("Are you sure you want to reset app screenshots description to default values?")) {
      setFormData({
        ...formData,
        ...DEFAULT_CONFIG,
      });
  ...
  return (
    <div className="min-h-screen pb-12">
      <PageHeader
        title="Dealer App - App Screenshots"
        description="Configure titles, subtitles, and slider screenshot descriptions details for the user-friendly interface design showcase"
      />
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm">
            ...
            >
              ...
              <p className="text-xs text-text/60 mb-5">
                {editingCard !== null ? "Modify the properties of this slide description." : "Create a new slide text description."}
              </p>
              ...
              <form onSubmit={handleSaveModalSolution} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Provide description details for this screen slide..."
                    required
        ...
        {savedSuccess && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-white/90">Dealer App screenshots descriptions updated successfully</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
