...
import { ShieldCheck, GitCompare, Star, Lock, Headphones, Target, Shield, Heart, Zap, Clock, Smile } from "lucide-react";
...
const DEFAULT_CONFIG = {
  ...
  featuresList: [
    { title: "Verified Installers", description: "All installers are background-verified with proper certifications and licenses.", icon: "ShieldCheck", enabled: true },
    { title: "Compare Quotes", description: "Get multiple quotes and compare pricing, services, and warranties.", icon: "GitCompare", enabled: true },
    { title: "Reviews & Ratings", description: "Read genuine reviews from previous customers to make informed decisions.", icon: "Star", enabled: true },
    { title: "Secure Payments", description: "Safe and secure payment processing with escrow protection.", icon: "Lock", enabled: true },
    { title: "24/7 Support", description: "Dedicated customer support to help you throughout your solar journey.", icon: "Headphones", enabled: true },
    { title: "Project Tracking", description: "Track your installation progress in real-time from start to finish.", icon: "Target", enabled: true }
  ],
...
export default function SolarShopMarketplaceFeatures() {
  ...
  const handleReset = () => {
    if (window.confirm("Are you sure you want to reset Key Features fields to default values?")) {
      setFormData({
        ...formData,
        ...DEFAULT_CONFIG,
      });
  ...
  return (
    <div className="min-h-screen pb-12">
      <PageHeader
        title="Marketplace - Key Features"
        description="Configure titles, feature cards, descriptions and custom icons for the Installer Marketplace page"
      />
                    ...
                    {formData.featuresList.map((sol, i) => {
                      ...
                      return (
                        <div key={i} className="bg-white border border-gray-150 p-4 rounded-xl text-left shadow-sm">
                          <div className="rounded-full bg-blue-50 p-2.5 text-blue-700 w-fit mb-2">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm">
            ...
            >
              ...
              <p className="text-xs text-text/60 mb-5">
                {editingCard !== null ? "Modify the properties of this marketplace feature." : "Create a new key feature card configuration."}
              </p>
              ...
              <form onSubmit={handleSaveModalSolution} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Verified Installers"
                    required
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Provide a short feature description..."
                    required
      ...
      <AnimatePresence>
        {savedSuccess && (
          ...
          >
            ...
            <div>
              <h4 className="font-bold text-sm">Key Features Saved</h4>
              <p className="text-xs text-white/90">Marketplace features updated successfully</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
