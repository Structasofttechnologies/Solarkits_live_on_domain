                ...
                <div className="flex-1 text-center md:text-left z-10 space-y-4">
                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-white/70">
                        <div className="flex items-center gap-2 text-sm font-medium">
                            ...
                            <span>{typeof user?.department === 'object' ? user?.department?.name : (user?.department || user?.role?.department?.name || 'Operations')}</span>
                        </div>
                        <div className="flex items-center gap-2 text-sm font-medium">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <InfoSection title="Organizational Profile" icon={HiIdentification}>
                        <DetailItem icon={HiOfficeBuilding} label="Department" value={typeof user?.department === 'object' ? user?.department?.name : (user?.department || user?.role?.department?.name || 'Operations')} />
                        <DetailItem icon={HiUser} label="Designation" value={typeof user?.role === 'object' ? user?.role?.name : (user?.role || 'Administrator')} />
