...
const mockUsers = [
  { id: "USR-001", name: "Arjun Mehta", email: "arjun@emergesun.com", role: "Order Manager", lastLogin: "2 mins ago", status: "Active" },
  { id: "USR-002", name: "Priya Nair", email: "priya@emergesun.com", role: "Warehouse Supervisor", lastLogin: "1 hr ago", status: "Active" },
  { id: "USR-003", name: "Rohit Singh", email: "rohit@emergesun.com", role: "Logistics Coordinator", lastLogin: "3 hrs ago", status: "Active" },
  { id: "USR-004", name: "Sneha Das", email: "sneha@emergesun.com", role: "Inventory Analyst", lastLogin: "Yesterday", status: "Inactive" },
  { id: "USR-005", name: "Karan Verma", email: "karan@emergesun.com", role: "Warehouse Supervisor", lastLogin: "30 mins ago", status: "Active" },
  { id: "USR-006", name: "Divya Patel", email: "divya@emergesun.com", role: "Logistics Coordinator", lastLogin: "2 days ago", status: "Suspended" },
];
