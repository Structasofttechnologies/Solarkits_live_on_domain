...
export default function DropdownWithSearchInput({
  ...
  return (
    <div className={`flex flex-col ${className}`}>
      {label && <label className="text-text-primary mb-1.5 font-semibold text-sm">{label}</label>}
            ...
            <div className="relative">
              ...
              >
                <Listbox.Options
                  ...
                  className={`absolute z-20 w-full bg-surface border-2 border-border rounded-xl shadow-lg 
                  max-h-64 overflow-auto scrollbar-hover ${openUp ? "bottom-full mb-1" : "mt-2"}`}
                  static
                >
