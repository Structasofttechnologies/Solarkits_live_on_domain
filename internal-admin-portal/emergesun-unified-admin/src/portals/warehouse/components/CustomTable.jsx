...
const CustomTable = ({
  ...
  return (
    <div className={`card overflow-hidden transition-all duration-300 min-w-0 ${containerClassName}`}>
      <div className="scrollbar-hover" style={{ overflowX: 'auto', overflowY: 'visible' }}>
