...
export const deleteSubtypeScope = async (payload, moduleUniqueId) => 
  await apiRequest("delete", "/product-templates/delete-subtype-scope", moduleUniqueId, "delete", { payload });
...
export const deleteBrandMapping = async (payload, moduleUniqueId) => 
  await apiRequest("delete", "/product-templates/delete-brand-mapping", moduleUniqueId, "delete", { payload });
